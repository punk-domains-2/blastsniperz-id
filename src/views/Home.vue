<template>
  <div class="container text-center">
    ...
    <div class="home-placeholder-div"></div>

    <div class="text-align-header mt-5 mb-2">
      <h1>Mint your {{getTldName}} web3 username!</h1>
      <p>
        ... and stay tuned for exciting new features where you'll be able to use it!
        <!--
        And use it as username on  
        <a href="https://blastsniperz.io" target="_blank">
          BlastSniperz, a decentralized social network on Blast
        </a>.
        -->
      </p>
    </div>
...
export default {
  ...
  setup() {
    ...
    return { address, buyNotValid, chainId, isActivated, open, signer, switchOrAddChain, toast }
  }
}
</script>
