<template>
  <div class="container-fluid text-center mt-3">
    ...
    <a target="_blank" href="https://blastsniperz.io">Built for BlastSniperz</a>
  </div>
  ...
  <div class="container-fluid text-center">
    ...
    <a class="icons" target="_blank" href="https://github.com/blast-sniperz"><i class="bi bi-github"></i></a>

    <a class="icons" target="_blank" href="https://discord.com/invite/blastsniperz"><i class="bi bi-discord"></i></a>

    <a class="icons" target="_blank" href="https://twitter.com/blastsniperz"><i class="bi bi-twitter"></i></a>
